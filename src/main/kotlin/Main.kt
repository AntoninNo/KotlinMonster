...
val Galum = EspeceMonstre(13, "Galum", "Minéral", 12, 15, 6, 8, 12, 55, 9.0, 13.0, 4.0, 6.5, 10.5, 13.0, "Golem ancien de pierre, yeux lumineux en garde.", "Peut rester immobile des heures comme une statue.", "Sérieux, stoïque, fiable")

var route1 = Zone(1,"route1",50,mutableListOf<EspeceMonstre>(Springleaf,Flamkip,Aquamy))
var route2 = Zone(2,"route2",75,mutableListOf<EspeceMonstre>(Laoumi,Bugsyface,Galum))
